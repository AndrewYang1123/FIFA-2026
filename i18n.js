...
(function () {
  ...
  var I18N = {
    ...
    hl_hero_p: { zh: `從1986年到2022年 — 每屆決賽的關鍵進球，約1分鐘精華剪輯`, en: `From 1986 to 2022 — the key goals from every final, in roughly 1-minute highlight clips` },
    hl_notice: { zh: `⚠️ <strong>觀看說明：</strong>點擊「▶ 在 YouTube 觀看」按鈕即可跳轉至 YouTube 搜尋該屆決賽精華片段。影片均來自 FIFA 官方頻道或授權媒體，每段約 1 分鐘。部分影片依地區可能有版權限制。`, en: `⚠️ <strong>How to watch:</strong> Click the "▶ Watch on YouTube" button to jump to a YouTube search for that final's highlight clip. Videos come from official FIFA channels or licensed media and run roughly 1 minute each. Some clips may carry regional copyright restrictions.` },
